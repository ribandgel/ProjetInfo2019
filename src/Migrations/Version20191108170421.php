 ...
 */
final class Version20191108170421 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE beverage (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, dtype VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE wine (id INT NOT NULL, winery_id INT NOT NULL, INDEX IDX_560C646832FAE8E8 (winery_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE wine ADD CONSTRAINT FK_560C6468BF396750 FOREIGN KEY (id) REFERENCES beverage (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE wine DROP FOREIGN KEY FK_560C6468BF396750');
